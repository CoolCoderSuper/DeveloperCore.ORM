...
Public MustInherit Class DataContext
    ...
    Public Overridable Sub Insert(obj As Object, type As Type, transaction As SqlTransaction)
    ...
    Public Overridable Sub Update(obj As Object, type As Type, transaction As SqlTransaction)
        Dim tableNameAttr As TableNameAttribute = type.GetCustomAttribute(Of TableNameAttribute)
